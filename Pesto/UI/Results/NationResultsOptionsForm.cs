...
{
	partial class NationResultsOptionsForm : Form
	{
		public NationResultsOptionsForm(Models.Competition competition)
		{
			InitializeComponent();

			PopulateTasks(competition);
		}

		public int[] SelectedTaskNumbers { get; private set; }

		private void PopulateTasks(Models.Competition competition)
		{
